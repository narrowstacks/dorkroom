...
Tri-X 400 exhibits minimal reciprocity failure for exposures under 1 second. For longer exposures:

- 1 second: No compensation needed
- 10 seconds: Add +1/3 stop
- 100 seconds: Add +1 stop

Consult the manufacturer's data sheet for precise compensation values.
