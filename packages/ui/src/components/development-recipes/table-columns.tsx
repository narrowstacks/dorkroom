 ...
 */
// eslint-disable-next-line react-doctor/no-multi-component-file, react-doctor/only-export-components -- cell-renderer colocated with createTableColumns; the column factory references it directly and extracting fragments a cohesive module
