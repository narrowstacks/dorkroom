...
const rawAspectRatiosData = [
  ...
  { label: '6x4.5 (4:3)', width: 4, height: 3 },
  { label: '6x6 (1:1)', width: 1, height: 1 },
  { label: '6x7 (7:6)', width: 7, height: 6 },
  { label: '6x8 (4:3)', width: 4, height: 3 },
  { label: '6x9 (3:2)', width: 3, height: 2 },
  { label: '6x12 (2:1)', width: 2, height: 1 },
  { label: '6x17 (17:6)', width: 17, height: 6 },
  { label: '4x5 (5:4)', width: 5, height: 4 },
  { label: '5x7 (7:5)', width: 7, height: 5 },
  { label: '8x10 (5:4)', width: 5, height: 4 },
  { label: '11x14 (14:11)', width: 14, height: 11 },
  { label: '16x20 (5:4)', width: 5, height: 4 },
  { label: '20x24 (6:5)', width: 6, height: 5 },
] as const;

const rawPaperSizesData = [
  { label: '5x7', width: 7, height: 5 },
  { label: '8x10', width: 10, height: 8 },
  { label: '8.5x11', width: 11, height: 8.5 },
  { label: '9x12', width: 12, height: 9 },
